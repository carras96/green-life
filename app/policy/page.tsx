        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-black mt-6 mb-8 leading-tight">
              Chính sách <br /> <span className="text-brand">Bảo mật & Điều khoản</span>
            </h1>
            <p className="text-slate-400 text-lg font-medium leading-relaxed max-w-2xl">
              Sự tin tưởng của quý khách là tài sản quý giá nhất của GreenLife.
              Chúng tôi luôn minh bạch và trách nhiệm trong mọi chính sách hoạt động.
            </p>
          </motion.div>
        </div>
        {/* Decorative elements */}
        ...
        <div className="max-w-7xl mx-auto px-6">
              ...
              >
                ...
                <div className="space-y-6">
                  {section.content.map((item, i) => (
                    <div key={i} className="flex gap-4 items-start p-6 border border-slate-50 hover:border-brand/10 rounded-2xl transition-all group">
          ...
          <div className="mt-32 p-16 bg-slate-50 rounded-[3rem] border border-slate-100 flex flex-col md:flex-row items-center justify-between gap-12">
            <div className="max-w-xl">
              ...
              <h3 className="text-2xl font-black text-slate-900 mb-6">Bạn có thắc mắc về quyền lợi của mình?</h3>
              <p className="text-slate-500 font-medium leading-relaxed text-sm">
                Đội ngũ pháp lý và hỗ trợ khách hàng của chúng tôi luôn sẵn sàng giải thích chi tiết các điều khoản
                để bạn hoàn toàn yên tâm khi mua sắm tại GreenLife.
              </p>
            </div>
