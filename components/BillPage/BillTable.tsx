          ...
          <Table className="w-full table-fixed border-collapse">
            <TableHeader>
              <TableRow className="bg-green-600 hover:bg-green-600 border-none">
                ...
                <TableHead className="w-[50px] text-center text-white border-r border-green-500 uppercase text-[10px] font-bold">
                  STT
                </TableHead>
                <TableHead className="w-[250px] text-center text-white border-r border-green-500 uppercase text-[10px] font-bold">
                  Tên hàng hóa
                </TableHead>
                <TableHead className="w-[80px] text-center text-white border-r border-green-500 uppercase text-[10px] font-bold">
                  SL
                </TableHead>
                <TableHead className="w-[120px] text-center text-white border-r border-green-500 uppercase text-[10px] font-bold">
                  Đơn giá
                </TableHead>
                <TableHead className="w-[150px] text-center text-white uppercase text-[10px] font-bold">
                  Thành tiền
                </TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {fields.map((field, index) => {
                ...
                return (
                  ...
                  >
                    <TableCell className="text-center border-r border-gray-200 py-1 text-xs text-gray-500">
                      {index + 1}
                    </TableCell>
                        ...
                        render={({ field: { onChange, value, ref } }) => (
                          <NumericFormat
                            ...
                            onValueChange={(values) => {
                              ...
                              onChange(
                                values.value === '' ? '' : values.floatValue
                              )
                            }}
                            thousandSeparator=","
                            allowNegative={false}
          ...
          <div className="w-full max-w-md space-y-3">
            ...
            <div className="flex justify-between font-bold text-gray-900 text-lg pt-3">
              ...
              <span className="text-green-700 font-mono">
                {totalPayment > 0 ? totalPayment.toLocaleString() : '0'}{' '}
